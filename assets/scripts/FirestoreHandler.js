...
import { doc, getDoc, setDoc, updateDoc, deleteDoc, deleteField, getDocs, collection, query as firestoreQuery, where, onSnapshot, arrayUnion, arrayRemove } from "https://www.gstatic.com/firebasejs/12.5.0/firebase-firestore.js";
...
const Get = async (CollectionName, Document, SubCollectionName) => {
    try {
...
export default function Firestore({ CollectionName, Type, Document, Method, Data, Value, Field, Operator, SubCollection, SubDocument, Callback }) {
    switch (Method) {
        case "get":
            return Get(CollectionName, Document, SubCollection);
